<div class="modal-detail">
    @foreach($workItem as $item)
        ...
        <div class="modal fade js-modal-detail-work-item-{{$item->id}}" id="manPowersModal_{{$item->work_item_id}}" tabindex="-1" role="dialog" aria-labelledby="materialsModal_{{$item->work_item_id}}Label" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <table class="table table-striped">
                            ...
                            @foreach($item?->workItems?->manPowers as $manPower)
                                ...
                                <tr>
                                    ...
                                    <td>{{$workItemController->toCurrency($rateManPower * $labor_coef)}}</td>
                                </tr>
                            @endforeach
                            </tbody>
                        </table>
