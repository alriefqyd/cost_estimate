...
<span style="font-family: Arial, Helvetica, sans-serif;">* USD converted from IDR (1 USD = {{toCurrency($usdIdr)}}).</span>
<table class="tbd" style="font-family: Arial, Helvetica, sans-serif; font-size: 12px">
    <thead>
        <tr>
            <th style="background-color: #FFC000">LOC/<br>EQUIP</th>
            <th style="background-color: #FFC000">DISCI<br>PLINE</th>
            <th style="background-color: #FFC000">WORK<br>ELEMENT</th>
            <th style="background-color: #FFC000">DESCRIPTION</th>
            {{-- <th rowspan="2" style="background-color: #FFC000">WORK ITEM</th>--}}
            <th style="background-color: #FFC000">LABOR COST (IDR)</th>
            <th style="background-color: #FFC000">TOOL AND <br>EQUIPMENT COST (IDR)</th>
            <th style="background-color: #FFC000">MATERIAL COST (IDR)</th>
            <th style="background-color: #FFC000">TOTAL WORK COST (IDR)</th>
            <th style="background-color: #FFC000">TOTAL WORK COST (USD)</th>
        </tr>
    </thead>
    <tbody>
    @php($totalCost = 0)
