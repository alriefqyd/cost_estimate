            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 text-end d-flex justify-content-end align-items-center gap-2">
                    @can('create', App\Models\Material::class)
                        <a class="btn btn-outline-primary" href="/material/create">Create New Material</a>
                    @endcan
                </div>
            </div>
        </div>
                        ...
                        <form method="get" action="/material">
                            <div class="row">
                                ...
                                <div class="col-md-3 mb-1">
                                    <input type="text" value="{{request()->q}}" name="q" placeholder="Code / Description / Stock Code / Ref Material Number" class="form-control js-search-form" style="height: 40px">
