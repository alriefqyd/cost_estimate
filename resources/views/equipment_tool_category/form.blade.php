    ...
    <div class="col-md-4">
        <div class="mb-3">
            ...
            <input class="form-control js-tool-equipment-code"
                   value="{{isset($equipment_tools_category?->code) ? $equipment_tools_category->code : old('code')}}"
                   name="code" type="text">
        </div>
    </div>
    <div class="col-md-8">
        <div class="mb-3">
            ...
            <input class="form-control js-tool-equipment-description"
                   value="{{isset($equipment_tools_category?->description) ? $equipment_tools_category->description : old('description')}}"
