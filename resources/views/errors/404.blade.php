...
{{-- can custom page http handler request by create a folder errors in views and name it same as the status like 404
    we can create all 500 status in one page view by name it 5xx.blade.php
--}}
